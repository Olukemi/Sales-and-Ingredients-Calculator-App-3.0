...
print "The list above is a list of all the ingredients used to make your product, how much of each you started the week with and their stock numbers in (kg,quanity(4))"
